...
<div class="container">
    ...
    <div class="row">
        ...
        Investor Experience (IX) Platform - Chat
        </h1>
    ...
    <div class="row">
        <div class="col-sm-12"> 
               ...
               <h2>Customer success software suite</h2>
    ...
    <div class="row">
        ...
        <div class="col-12 col-lg-8"> 
           <img src="https://149474761.v2.pressablecdn.com/wp-content/themes/six-usm/assets/img/ie-ix/chat/chat.png" class="ix-multi-screen"></noscript>
        </div><!--col-->
        ...
        <div class="col-12 col-lg-4">
            ...
            <div class="row">
                  ...
                  <div class="col-12">
                         ...
                         <h5 class="ix-multi-title-small">Real-time communication</h5>
                         <span class="exp-pts-line-white"></span>
                         <p class="ix-multi-subline-small">
                         Follow along with everything related to individual topics, projects or teams in their dedicated channels.</p>

                    </div><!--col--> 

                     <div class="col-12">

                         <h5 class="ix-multi-title-small">History you can see & search</h5>
                         <span class="exp-pts-line-white"></span>
                         <p class="ix-multi-subline-small">
                         Projects end, teams change, Chat saves everything. Rather than trying to remember, easily find what you’re looking for.</p>

                    </div><!--col--> 

                     <div class="col-12">

                         <h5 class="ix-multi-title-small">Collaborate with others</h5>
                         <span class="exp-pts-line-white"></span>
                         <p class="ix-multi-subline-small">
                         Keep investors, analysts, and other companies in the loop by sharing a channel in Chat. Work moves faster when conversations do, too.</p>
